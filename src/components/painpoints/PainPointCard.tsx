...
const PainPointCard = ({ pain, solution, caption, visual }: Props) => (
  <div className="group relative h-full min-h-[20.6rem] overflow-hidden rounded-[1.55rem] border border-[#bdd0ee]/80 bg-white/62 text-[#101831] shadow-[0_26px_70px_rgba(48,75,130,0.12),inset_0_1px_0_rgba(255,255,255,0.94)] backdrop-blur-2xl transition duration-500 hover:-translate-y-1 hover:border-[#9cb7e4]/90 hover:shadow-[0_34px_86px_rgba(48,75,130,0.16),inset_0_1px_0_rgba(255,255,255,0.98)]">
    ...
    <div className="relative min-h-[6.9rem] border-b border-[#d7dbe7]/85 bg-[linear-gradient(180deg,rgba(255,241,242,0.66),rgba(255,247,248,0.24))] px-7 pb-5 pt-6">
    ...
    <div className="relative px-7 pb-6 pt-5">
      ...
      <div className="relative mb-5 h-[7.75rem] overflow-hidden rounded-[1.15rem] border border-white/76 bg-white/58 shadow-[0_18px_42px_rgba(61,84,133,0.1),inset_0_1px_0_rgba(255,255,255,0.96)] backdrop-blur-xl">
